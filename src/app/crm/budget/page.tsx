...
import { budgetColumns } from "./columns/columns";
...
const Budget = () => {
  ...
  return (
    <div>
      <AddBudgetModal open={dialog} onClose={() => setDialog(false)} />
      <div>
        <p className="text-2xl font-bold text-secondary-foreground">Budget</p>
      </div>
      <div className="mt-3">
        <Card>
          <CardContent className="p-4">
            ...
            <div className="mt-5">
              <CustomTable data={rowData} columns={budgetColumns} />
            </div>
          </CardContent>
        </Card>
      </div>
