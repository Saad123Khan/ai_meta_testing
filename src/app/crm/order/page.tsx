...
import { orderColumns } from "./columns/columns";
...
const Order = () => {
  ...
  return (
    <div>
      <AddOrderModal open={dialog} onClose={() => setDialog(false)} />
      <div>
        <p className="text-2xl font-bold text-secondary-foreground">Order</p>
      </div>
      <div className="mt-3">
        <Card>
          <CardContent className="p-4">
            ...
            <div className="mt-5">
              <CustomTable data={rowData} columns={orderColumns} />
            </div>
          </CardContent>
        </Card>
      </div>
